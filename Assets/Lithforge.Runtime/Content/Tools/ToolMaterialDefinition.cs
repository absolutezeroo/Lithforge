...
namespace Lithforge.Runtime.Content.Tools
{
    ...
    public sealed class ToolMaterialDefinition : ScriptableObject
    {
        ...
        [Header("Head / Blade Stats"), Min(0.1f)]
         public float headMiningSpeed = 1f;
        ...
        [Header("Handle Stats"), Min(0.1f)]
         public float handleDurabilityMultiplier = 1f;
        ...
        [Header("Binding / Guard Bonus"), Min(0)]
         public int bindingDurabilityBonus;
        ...
        /// </summary>
        [Header("Part Builder"), Tooltip("If true, this material can be used in the Part Builder (wood, stone, flint...). " +
                                         "If false, parts must be made via Smeltery/Casting (iron, gold, diamond...).")]
        ...
        [Tooltip("Material cost in items to craft one part in the Part Builder. " +
                 "Individual recipes can override this via costOverride."), Min(1)]
         public int partBuilderCost = 2;
        ...
        /// </summary>
        [Header("Part Builder Material Inputs"), Tooltip("Items accepted as material input. Each entry maps an item to this material " +
        ...
        /// </summary>
        [Header("Sprite Compositing"), Tooltip("Suffix used in texture filenames (e.g. 'iron', 'wood'). " +
                                               "Must match the part after the underscore in texture names like 'head_iron.png'. " +
                                               "If empty, defaults to the Name part of materialId.")]
