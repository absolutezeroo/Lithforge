...
namespace Lithforge.Runtime.Content.Blocks
{
    ...
    public sealed class BlockPropertyEntry
    {
        ...
        [FormerlySerializedAs("_name"), Tooltip("Property name (e.g. 'facing', 'lit', 'axis')"), SerializeField]
         private string name;

        /// <summary>How this property generates its value set (bool, int range, or explicit enum).</summary>
        [FormerlySerializedAs("_kind"), Tooltip("Property type"), SerializeField]
         private BlockPropertyKind kind;

        /// <summary>Explicit value list — only used when Kind is Enum.</summary>
        [FormerlySerializedAs("_values"), Tooltip("Possible values (for enum type, or auto-generated for bool/int)"), SerializeField]
         private List<string> values = new();

        /// <summary>Value assigned when no property string is specified in a block state.</summary>
        [FormerlySerializedAs("_defaultValue"), Tooltip("Default value"), SerializeField]
         private string defaultValue;

        /// <summary>Inclusive lower bound for IntRange properties.</summary>
        [FormerlySerializedAs("_minValue"), Tooltip("Min value (for int range type)"), SerializeField]
         private int minValue;

        /// <summary>Inclusive upper bound for IntRange properties.</summary>
        [FormerlySerializedAs("_maxValue"), Tooltip("Max value (for int range type)"), SerializeField]
