...
namespace Lithforge.Runtime.Content.Behaviors
{
    ...
    public sealed class SpawnEntityAction : BehaviorAction
    {
        ...
        [FormerlySerializedAs("_entityId"), Tooltip("Entity prefab or id to spawn"), SerializeField]
         private string entityId;

        /// <summary>World-space offset from the block origin where the entity appears.</summary>
        [FormerlySerializedAs("_spawnOffset"), Tooltip("Spawn offset from block position"), SerializeField]
         private Vector3 spawnOffset = new(0.5f, 1.0f, 0.5f);
