...
{
    /// <summary>
    /// Vertex format for the first-person arm mesh. Stored in a StructuredBuffer
    /// and read by the arm shader via SV_VertexID.
    /// 40 bytes, 8-byte aligned. Separate from PackedMeshVertex because the arm
    /// needs float positions relative to part pivots, normals, UVs, and a bone index,
    /// none of which overlap with the voxel vertex encoding.
    /// </summary>
    [StructLayout(LayoutKind.Sequential)]
    public struct PlayerArmVertex
    {
